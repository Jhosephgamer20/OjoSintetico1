...
<main class="form-signin w-100 m-auto">
  <form action="" method="post">
    <img class="mb-4" src="../IMG/2.png" width="300">
    <h4 class="text-secondary">INGRESA LOS SIGUIENTES DATOS.</h4>
    <div class="form-floating">
      <input type="text" class="form-control" id="floatingInput" placeholder="Ingrse su Nombre " required autofocus pattern="[A-Za-z0-9]{8,12}">
      <label for="floatingInput">Nombre:</label>
    </div>
    <div class="form-floating">
      <input type="apellido" class="form-control" id="floatingApellido" placeholder="Ingrese su Apellido" required pattern="[A-Za-z0-9]{8,12}">
      <label for="floatingApellido">Apellido:</label>
    </div>
    <div class="form-floating">
      <input type="correo" class="form-control" id="floatingCorreo" placeholder="Ingrese su Correo" required pattern="[A-Za-z0-9]{8,12}">
      <label for="floatingCorreo">Correo:</label>
    </div>
    <div class="form-floating">
      <input type="user" class="form-control" id="floatinguser" placeholder="Ingrese su Usuario" required pattern="[A-Za-z0-9]{8,12}">
